...
{ lib, ... }:
let
  mkShowOption = default: desc: lib.mkOption {
    inherit default;
    type = lib.types.bool;
    description = desc;
  };
...
in
{
  options.eiros.system.user_defaults.dms.bar = {
    ...
    show_launcher_button = mkShowOption true "Show the app launcher button in the bar.";
    show_workspace_switcher = mkShowOption true "Show the workspace switcher in the bar.";
    show_focused_window = mkShowOption true "Show the focused window title/icon in the bar.";
    show_weather = mkShowOption true "Show the weather widget in the bar.";
    show_music = mkShowOption true "Show the media player widget in the bar.";
    show_clipboard = mkShowOption true "Show the clipboard history widget in the bar.";
    show_cpu_usage = mkShowOption true "Show the CPU usage widget in the bar.";
    show_mem_usage = mkShowOption true "Show the memory usage widget in the bar.";
    show_cpu_temp = mkShowOption true "Show the CPU temperature widget in the bar.";
    show_gpu_temp = mkShowOption true "Show the GPU temperature widget in the bar.";
    show_system_tray = mkShowOption true "Show the system tray in the bar.";
    show_clock = mkShowOption true "Show the clock widget in the bar.";
    show_notification_button = mkShowOption true "Show the notification center toggle button in the bar.";
    show_battery = mkShowOption true "Show the battery indicator in the bar.";
    show_control_center_button = mkShowOption true "Show the control center toggle button in the bar.";
    show_caps_lock_indicator = mkShowOption true "Show the caps lock indicator in the bar.";
